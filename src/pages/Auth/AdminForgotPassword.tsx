    ...
    return (
        ...
        <div className="w-full max-w-lg bg-white rounded-2xl shadow-xl px-10 py-16">
            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-5">
                ...
                <button
                    type="submit"
                    className={`w-full bg-secondary text-white py-3 mt-10 rounded-lg hover:opacity-95 transition-all flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed ${
                ...
                <p className="text-center text-gray-600">
                    ...
                    <a href="/admin/auth/login" className="text-green-700 hover:underline">
                        here
                    </a>
                </p>
            </form>
